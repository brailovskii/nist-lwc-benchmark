...
void init_buffer(uchar_t *buffer, ullint_t numbytes);
void fprint_bstr(FILE *fp, const char *label, const uchar_t *data,
                 ullint_t length);
...
int generate_test_vectors(void)
{
  ...
  uchar_t msg[MAX_MESSAGE_LENGTH], digest[CRYPTO_BYTES];
